...
const CATEGORIES = [
  {
    ...
    tagline: 'Pipelines, warehouses, scale.',
    Icon: FiDatabase,
    tint: 'blue',
    skills: [
      'SQL', 'Python', 'Snowflake', 'Databricks', 'Fivetran',
      'Pandas | NumPy', 'ETL Pipelines', 'PostgreSQL', 'MongoDB',
      'Spark', 'Hadoop', 'dbt', 'Docker', 'AWS', 'Azure', 'GCP',
    ],
  },
  {
    id: 'ml',
    name: 'Machine Learning',
    tagline: 'Models, vision, deployment.',
    Icon: FiCpu,
    tint: 'purple',
    skills: [
      'PyTorch', 'Hugging Face', 'Vision-Language Models', 'PaddleOCR',
      'RT-DETR', 'XGBoost', 'LightGBM', 'CatBoost', 'TensorFlow',
      'Keras', 'scikit-learn', 'Neural Networks', 'Feature Engineering',
      'SHAP', 'GPU Optimization',
    ],
  },
  {
    id: 'da',
    name: 'Data Analytics',
    tagline: 'Insight, every day.',
    Icon: FiBarChart2,
    tint: 'teal',
    skills: [
      'R-Studio', 'Tableau', 'PowerBI', 'Looker', 'Excel',
      'Seaborn | Matplotlib', 'Statistical Analysis', 'A/B Testing',
    ],
  },
  {
    id: 'fe',
    name: 'Frontend',
    tagline: 'React, in production.',
    Icon: FiCode,
    tint: 'pink',
  ...
  },
  {
    ...
    tint: 'silver',
    skills: [
      'Git', 'Bash', 'Jupyter', 'JIRA', 'G-Suite', 'MS Office',
      'Adobe Premiere Pro', 'Blender 3D',
    ],
  },
];
...
const CLOUD_SKILLS = [
  ...
  'XGBoost', 'LightGBM', 'Hugging Face', 'PaddleOCR', 'RT-DETR',
  'Snowflake', 'Databricks', 'Spark', 'AWS', 'GCP', 'Azure',
  'Docker', 'Pandas', 'NumPy', 'Tableau', 'PowerBI', 'Looker',
  'R-Studio', 'React', 'Node.js', 'MongoDB', 'PostgreSQL',
  'Git', 'Jupyter', 'SHAP', 'dbt', 'Keras',
];
